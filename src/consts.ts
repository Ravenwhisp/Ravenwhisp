...
export const GITHUB_URL = 'https://github.com/Ravenwhisp/Ravenwhisp'
export const SITE_URL = 'https://ravenwhisp.github.io/Ravenwhisp/'
...
export const COMPANY_INFO = {
  ...
  url: SITE_URL,
  logo: withBasePath('/images/site-logo.png'),
  foundingDate: '2026',
